        ...
        <div class="boardBox">
            <div class="pull-right amountDiv">
	                <select name="" id="amount">
		                    <option value="10" ${pageMaker.cri.amount == 10 ? 'selected' : ''}>10개씩</option>
		                    <option value="20" ${pageMaker.cri.amount == 20 ? 'selected' : ''}>20개씩</option>
		                    <option value="30" ${pageMaker.cri.amount == 30 ? 'selected' : ''}>30개씩</option>
	                </select>
            </div>
            ...
            <div class="searchDiv">
                ...
                <input type="text" id="keyword" value="${pageMaker.cri.keyword}">
